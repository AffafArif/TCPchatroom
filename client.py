...
client.connect(('127.0.0.1', 55555))  #client connects to localhost. Here server will trigger its except method

# Listening to Server and Sending Nickname
def receive():  #runs constantly to recieve data from server
    while True:
        try:
